    ...
    <div>
      <form onSubmit={(e) => onSubmit(e)} className="container mt-3">
        <div
          ...
          id={`editMedicineId${medicine.medicine_id}`}
          tabindex="-1"
          role="dialog"
                ...
                {values.prescription === true && (
                  <div>
                    ...
                    >
                      {medicine.doctor_id ? (
                        <>
                          <option value={medicine.doctor_id}>
                        ...
                        <>
                          <option value="other" selected={otherPrescriber}>
                            Other
                          </option>
                        </>
                      ) : (
                      ...
                      {doctors
                        .filter(
                          (doctor) => doctor.doctor_id !== medicine.doctor_id
                        )
                        .map((doctor) => (
                          <option
